...
import ArtifactGallery from "@/components/ArtifactGallery"; // Imported new gallery
    ...
    <main className="min-h-full w-full bg-[#F9F8F6] text-zinc-700 selection:bg-blue-100 pb-24">
      <div className="max-w-6xl mx-auto px-8 py-12 lg:py-16">
        ...
        <nav className="mb-10 border-b border-zinc-200 pb-4 flex items-center gap-2">
          <Link
            href="/inventory"
            className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-600 hover:text-blue-600 transition-colors"
          >
            Catalog
          </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <section className="lg:col-span-6 lg:pl-6">
            <div className="mb-8">
              <span className="text-xs font-mono text-zinc-600 mb-2 block uppercase">
                Inventory Ref:{" "}
              ...
              <div className="flex items-center gap-4">
                ...
                <span
                  className={`text-[10px] font-bold uppercase tracking-widest border px-3 py-1 ${isSold ? "border-zinc-200 text-zinc-400 bg-zinc-50" : "border-blue-100 text-blue-600 bg-blue-50"}`}
                >
            ...
            <div className="grid grid-cols-2 gap-8 py-6 border-y border-zinc-200 mb-10">
              <div>
                <h4 className="text-[10px] uppercase font-black tracking-widest text-zinc-600 mb-1">
                  Weight
                </h4>
            ...
            <div className="space-y-3">
              {isSold ? (
                ...
                <form action={createCheckout}>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-zinc-800 text-white py-4 text-lg font-bold uppercase tracking-widest hover:bg-blue-600 transition-all"
                  >
                    Purchase Now
                  </button>
                </form>
                ...
                <a
                  ...
                  className="w-full bg-zinc-800 text-white py-4 text-lg font-bold uppercase tracking-widest hover:bg-blue-600 transition-all text-center block"
                >
                  Inquire for Price
                </a>
              )}
