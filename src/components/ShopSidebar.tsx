  ...
  return (
    <aside className="w-64 shrink-0 hidden lg:block">
      <div className="sticky top-32 pr-8 self-start">     
				<h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-10">
					Inventory
				</h3>
            ...
            return (
              <div key={id} className="space-y-2">
                ...
                <div className="flex items-center justify-between group">
                  ...
                  >
                    {parent.name}
                    <span className="ml-2 text-[9px] font-medium text-zinc-400 group-hover:text-blue-400 transition-colors">
                      ({parent.totalCount})
                    </span>
                  </button>
                  ...
                  {hasChildren && (
                    <button
                      ...
                      className="p-1 hover:bg-zinc-200 rounded transition-colors cursor-pointer text-zinc-400"
                    >
                      <ChevronRight
                        size={14}
