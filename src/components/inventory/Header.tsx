    ...
    <header className="sticky top-0 z-50 w-full bg-[#F9F8F6] border-b border-zinc-200">
      <div className="mx-auto px-4 md:px-10">
        <div className="flex h-20 items-center justify-between">
          ...
          <nav className="flex-1 hidden lg:flex items-center gap-8">
            <Link
              href="/inventory"
              className="text-label font-black uppercase tracking-[0.3em] text-zinc-500 hover:text-blue-600 transition-colors"
            >
              Catalog
            </Link>
            <Link
          ...
          <div className="flex-none text-center px-2">
            <Link href="/" className="group" onClick={closeMobileMenu}>
              <h1 className="text-2xl md:text-2xl font-bold uppercase tracking-[0.3em] md:tracking-[0.4em] text-zinc-600 leading-none">
                Catskill
              </h1>
              <p className="text-detail md:text-detail uppercase tracking-[0.3em] md:tracking-[0.6em] text-zinc-600 font-medium mt-1 group-hover:text-blue-600 transition-colors whitespace-nowrap">
      ...
      >
        <form
          ...
          className="px-6 md:px-10 py-6 max-w-7xl mx-auto flex items-center gap-4 md:gap-6"
        >
          ...
          <input
            ...
            className="w-full bg-transparent border-none outline-none text-label md:text-xs font-bold uppercase tracking-[0.2em] text-zinc-800 placeholder:text-zinc-300"
          />
          <button
            type="submit"
            className="hidden md:block text-label font-black uppercase tracking-widest text-blue-600 hover:text-zinc-900 transition-colors shrink-0"
          >
            Search
          </button>
        </form>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 top-20 bg-[#F9F8F6] z-50 p-8 animate-in fade-in slide-in-from-top-4 duration-300">
          ...
          <div className="mt-auto pb-10">
            <p className="text-label font-black uppercase tracking-[0.4em] text-zinc-400">
